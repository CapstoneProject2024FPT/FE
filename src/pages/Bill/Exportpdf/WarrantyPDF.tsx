  ...
  <Document>
    <Page style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <Text>
          Sản phẩm: {product?.warrantyDetails?.inventory?.machinery?.name || ""}
        </Text>
        <Text>
      ...
      <View style={styles.warrantyTermsContainer}>
        <View style={styles.warrantyTermsSection}>
          ...
          <Text style={styles.warrantyTermsContent}>
            1. Chúng tôi chỉ chịu trách nhiệm bảo hành sau khi đã xác định lỗi
            thuộc về sản xuất.
          </Text>
          <Text style={styles.warrantyTermsContent}>
            2. Phiếu bảo hành phải được giữ nguyên, không bị tẩy xóa, sửa đổi
            trong thời gian bảo hành.
          </Text>
          <Text style={styles.warrantyTermsContent}>
            3. Thiết bị được sửa chữa miễn phí tại trung tâm trong suốt thời
            gian bảo hành của nhà sản xuất.
          </Text>
          <Text style={styles.warrantyTermsContent}>
            4. Những sản phẩm bảo hành ngoài nội thành Thành Phố Hồ Chí Minh,
            chi phí đi lại khách hàng chịu trách nhiệm.
          </Text>
          <Text style={styles.warrantyTermsContent}>
            5. Đối với những sản phẩm có giá trị dưới 8 triệu bảo hành tại công
            ty.
          </Text>
        </View>
        <View style={styles.warrantyTermsSection}>
          ...
          <Text style={styles.warrantyTermsContent}>
            3. Khách hàng tự tháo mở, sửa chữa, thay đổi lại máy ở cơ sở khác
            khi chưa được sự đồng ý.
          </Text>
          <Text style={styles.warrantyTermsContent}>
            4. Máy móc hoặc linh kiện bị hỏng hóc, đứt dây, không đầy đủ linh
            kiện, sử dụng ngôn ngữ điện áp không phù hợp.
          </Text>
          <Text style={styles.warrantyTermsContent}>
            5. Sản phẩm bị hư hỏng do bảo quản không tốt, côn trùng, thiên tai,
            hoả hoạn.
          </Text>
          <Text style={styles.warrantyTermsContent}>
            Lưu ý: Tiếp nhận yêu cầu bảo hành vào giờ hành chính từ thứ 2 đến
    ...
    const fetchWarrantyData = async () => {
      try {
        const response = await apiGetWarranty({
          InventoryId: product?.warrantyDetails?.inventory?.id,
        });
