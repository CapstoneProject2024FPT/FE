...
const UserProfile: React.FC = () => {
    ...
    return (
        <>
            ...
            <div style={{ backgroundColor: "#ECF0F1", borderRadius: "20px", width: "65%", height: "100%" }}>
                <Box sx={{ flexGrow: 1, margin: "2%", padding: "20px" }}>
                    <Grid container spacing={2}>
                        <Grid xs={12} md={3}>
                            <List
                                sx={{ width: '100%', bgcolor: 'background.paper', borderRadius: '10px', border: "1px solid " }}
                                component="nav"
                                aria-labelledby="nested-list-subheader"
                                subheader={
                                    <ListSubheader component="div" id="nested-list-subheader" style={{ borderRadius: '10px' }}>
                                        Tên người dùng
                                    </ListSubheader>
                                }
                            >
                        ...
                        <Grid xs={12} md={9}>
                            <Box sx={{ marginLeft: "5%" }}>
                                <Paper sx={{ borderStyle: "none", padding: "20px", border: "1px solid " }}>
                                    <Grid container spacing={2}>
                                        <FormGrid xs={12} >
